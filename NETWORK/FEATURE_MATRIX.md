...
| 正序/倒序 | 详情 TOC 按钮 | 否 | 部分验证 | 无 | P1 | 按钮存在，切换未实际验证 |
...
| 评论本地分页 | .comments-page-N | 可选 | 部分验证 | 无 | P2 | 点击翻页因云浏览器超时未验证 |
| 留言板读取 | /guestbook/ | 可选 | 已验证 | 无 | P1 | 8 个本地分页组 |
...
| 评论提交 | form.commentEditor | 是 | 未验证 | 高 | P3 | 未提交 |
| 留言提交 | form.gbEditor | 是 | 未验证 | 高 | P3 | 未提交 |
...
- P3 默认不实现写入，除非用户在具体动作前确认并完成真实环境验证。
